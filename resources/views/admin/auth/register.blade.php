        ...
        <div class="row justify-content-center form-bg-image"
            ...
            <div class="col-12 d-flex align-items-center justify-content-center">
                <div
                    ...
                    <form action="{{ route('admin.register.post') }}" method="POST" role="form">
                        <!-- Form -->
                        @csrf
                        ...
                        <div class="form-group mb-4">
                            <label for="email">Avartar</label>
                            <div class="form-file mb-3">
                                <input type="file" class="form-file-input" id="customFile" name="avartar" required>
                    ...
                    <div class="d-flex justify-content-center align-items-center mt-4">
                        <span class="font-weight-normal">
                            ...
                            <a href="{{ route('admin.login') }}" class="font-weight-bold">Login here</a>
                        </span>
                    </div>
                </div>
            </div>
